  ...
  return (
    <div className='container'>
      ...
      <div className='card mt-5 bg-transparent border-0 position-absolute top-50 start-50 translate-middle'>
        <h2 className='display-4 fw-normal text-center text-light mb-4 mt-5'>Sign up</h2>
        ...
        <p className='text-light mt-5'>You already have an account ?
          <button className='btn btn-primary text-light mb-1 ml-3' onClick={() => { navigateToLogin() }}>Sign in!</button>
        </p>
      </div>
    </div>
  )
